...
@Component({
  ...
  styleUrls: ['./cdk-table.component.sass']
})
export class CdkTableComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    // After filtering out things that don’t match the search, sort our array based on the sorting column and direction held in BehaviorSubjects
